...
IXAudio2SourceVoice *Sound::m_apSourceVoice[SOUND_MAX] = {};// ソースボイス
BYTE *Sound::m_apDataAudio[SOUND_MAX] = {};					// オーディオデータ
DWORD Sound::m_aSizeAudio[SOUND_MAX] = {};					// オーディオデータサイズ
...
void Sound::Play(SoundLabel label)
{
...
void Sound::Stop(SoundLabel label)
{
	XAUDIO2_VOICE_STATE xa2state;
